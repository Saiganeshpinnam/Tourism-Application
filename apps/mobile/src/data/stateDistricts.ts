export const stateDistricts: Record<string, string[]> = {
  "Andhra Pradesh": [ "Anakapalli","Annamayya","Anantapur","Bapatla","Chittoor",
  "East Godavari","Eluru","Guntur","Kakinada","Konaseema","Krishna",
  "Kurnool","Nandyal","Nellore","NTR District","Palnadu",
  "Parvathipuram Manyam","Prakasam",
  "Sri Balaji Dist (Tirupati)","Sri Satyasai","Srikakulam",
